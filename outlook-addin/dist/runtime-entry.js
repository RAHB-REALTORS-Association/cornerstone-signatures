(() => {
  ...
  function createAccessTokenEntity(homeAccountId, environment, accessToken, clientId, tenantId, scopes, expiresOn, extExpiresOn, base64Decode2, correlationId, refreshOn, tokenType, userAssertionHash, keyId, additionalCacheKeyComponents) {
    ...
    const normalizedTokenType = (_a = atEntity.tokenType) == null ? void 0 : _a.toLowerCase();
    if (((_b = atEntity.tokenType) == null ? void 0 : _b.toLowerCase()) !== AuthenticationScheme.BEARER.toLowerCase()) {
      atEntity.credentialType = CredentialType.ACCESS_TOKEN_WITH_AUTH_SCHEME;
      switch (normalizedTokenType) {
        case AuthenticationScheme.POP:
          const tokenClaims = extractTokenClaims(accessToken, base64Decode2, correlationId);
          if (!((_c = tokenClaims == null ? void 0 : tokenClaims.cnf) == null ? void 0 : _c.kid)) {
    ...
    updateMetadataWithRegionalInformation(metadata) {
      return __async(this, null, function* () {
        ...
        if (userConfiguredAzureRegion) {
          ...
          const autodetectedRegionName = yield invokeAsync(this.regionDiscovery.detectRegion.bind(this.regionDiscovery), RegionDiscoveryDetectRegion, this.logger, this.performanceClient, this.correlationId)((_b = this.authorityOptions.azureRegionConfiguration) == null ? void 0 : _b.environmentRegion, this.regionDiscoveryMetadata);
          if (autodetectedRegionName) {
  ...
  function buildMergedClaims(claims, clientCapabilities, correlationId = "", claimsToMerge) {
    ...
    if (claimsToMerge == null ? void 0 : claimsToMerge.trim()) {
  ...
  var CacheManager = class {
    ...
    removeAccessToken(key, correlationId) {
      ...
      if (credential.credentialType.toLowerCase() === CredentialType.ACCESS_TOKEN_WITH_AUTH_SCHEME.toLowerCase()) {
        const tokenType = (_a = credential.tokenType) == null ? void 0 : _a.toLowerCase();
        switch (tokenType) {
          case AuthenticationScheme.POP:
          case AuthenticationScheme.DPOP.toLowerCase(): {
            ...
            if (kid) {
              void this.tokenBindingKeyManager.removeTokenBindingKey(kid, correlationId).catch(() => {
                ...
                (_a2 = this.performanceClient) == null ? void 0 : _a2.incrementFields({ removeTokenBindingKeyFailure: 1 }, correlationId);
              });
            }
            break;
          }
    ...
    getIdToken(account, correlationId, tokenKeys, targetRealm) {
      ...
      if (numIdTokens < 1) {
        ...
        if (!targetRealm) {
          ...
          if (numHomeIdTokens < 1) {
            ...
            return (_a = idTokenMap.values().next().value) != null ? _a : null;
          } else if (numHomeIdTokens === 1) {
            this.commonLogger.info("1eq2vc", correlationId);
            return (_b = homeIdTokenMap.values().next().value) != null ? _b : null;
          } else {
      ...
      return (_c = idTokenMap.values().next().value) != null ? _c : null;
    }
    /**
    ...
    matchAccessTokenWithAuthScheme(entity, filter) {
      var _a;
      const normalizedFilterTokenType = (_a = filter.tokenType) == null ? void 0 : _a.toLowerCase();
  ...
  var PopTokenGenerator = class {
    ...
    signPayload(payload, keyId, request, claims) {
      return __async(this, null, function* () {
        ...
        const shrAlgorithm = ((_a = shrOptions == null ? void 0 : shrOptions.header) == null ? void 0 : _a.alg) || publicKeyJwk.alg || SHR_TOKEN_BINDING_KEY_ALGORITHM;
        const shrHeader = JoseHeader.getShrHeader(__spreadProps(__spreadValues({}, shrOptions == null ? void 0 : shrOptions.header), {
          alg: shrAlgorithm,
  ...
  var DpopProofGenerator = class {
     ...
     */
    generateTokenProof(params, keyId, correlationId = "") {
      return __async(this, null, function* () {
     ...
     */
    generateResourceProof(params, keyId, correlationId = "") {
      return __async(this, null, function* () {
        const { htu, htm, nonce } = params;
        if (!htu || !htm) {
          throw createClientConfigurationError(dpopMissingResourceContext, correlationId);
        }
        const ath = yield this.cryptoUtils.hashString(params.accessToken);
    ...
    generateProof(claims, keyId, correlationId) {
      return __async(this, null, function* () {
        const publicJwk = yield this.tokenBindingKeyManager.getTokenBindingPublicKeyJwk(keyId, correlationId);
    ...
    handleServerTokenResponse(serverTokenResponse, authority, reqTimestamp, request, apiId, authCodePayload, userAssertionHash, handlingRefreshTokenResponse, forceCacheRefreshTokenResponse, serverRequestId, additionalCacheKeyComponents) {
      return __async(this, null, function* () {
        ...
        if (request.authenticationScheme === AuthenticationScheme.DPOP) {
          if (((_a = serverTokenResponse.token_type) == null ? void 0 : _a.toLowerCase()) !== AuthenticationScheme.DPOP.toLowerCase()) {
        ...
        const attributeTokenPartition = serializeAttributeTokens(request.attributeTokens);
        const cacheKeyComponents = additionalCacheKeyComponents != null ? additionalCacheKeyComponents : attributeTokenPartition ? {
          attribute_tokens: attributeTokenPartition
        } : void 0;
    ...
    static generateAuthenticationResult(_0, _1, _2, _3, _4, _5) {
      return __async(this, arguments, function* (cryptoObj, authority, cacheRecord, fromTokenCache, request, performanceClient, options = {}) {
        ...
        if (cacheRecord.accessToken) {
          const accessTokenType = (_a = cacheRecord.accessToken.tokenType) == null ? void 0 : _a.toLowerCase();
          ...
          if (accessTokenType === AuthenticationScheme.DPOP.toLowerCase()) {
            ...
            dpopProof = yield dpopProofGenerator.generateResourceProof({
        ...
        const regionSubScope = idTokenClaims == null ? void 0 : idTokenClaims.tenant_region_sub_scope;
        if (typeof regionSubScope === "string") {
          performanceClient == null ? void 0 : performanceClient.addFields({ regionSubScope }, request.correlationId);
        }
        ...
        const accountInfo = cacheRecord.account ? updateAccountTenantProfileData(
          ...
          idTokenClaims,
          (_b = cacheRecord.idToken) == null ? void 0 : _b.secret
        ) : null;
        return {
          ...
          account: accountInfo,
          idToken: ((_c = cacheRecord == null ? void 0 : cacheRecord.idToken) == null ? void 0 : _c.secret) || "",
          ...
          requestId: requestId || "",
          familyId,
          tokenType: ((_e = (_d = cacheRecord.accessToken) == null ? void 0 : _d.tokenType) == null ? void 0 : _e.toLowerCase()) === AuthenticationScheme.DPOP.toLowerCase() ? AuthenticationScheme.DPOP : ((_f = cacheRecord.accessToken) == null ? void 0 : _f.tokenType) || "",
          state: requestState ? requestState.userRequestState : "",
          cloudGraphHostName: ((_g = cacheRecord.account) == null ? void 0 : _g.cloudGraphHostName) || "",
          msGraphHost: ((_h = cacheRecord.account) == null ? void 0 : _h.msGraphHost) || "",
  ...
  function addDpopTokenProofHeader(headers, request, tokenEndpoint, cryptoUtils, tokenBindingKeyManager) {
    return __async(this, null, function* () {
      if (request.authenticationScheme !== AuthenticationScheme.DPOP) {
        return;
      }
      ...
      if (!(keyId == null ? void 0 : keyId.trim())) {
        throw createClientAuthError(keyIdMissing, request.correlationId);
      }
      headers[HeaderNames.DPOP] = yield dpopProofGenerator.generateTokenProof({
        tokenEndpoint
  ...
  var AuthorizationCodeClient = class {
    ...
    executeTokenRequest(authority, request, serverTelemetryManager) {
      return __async(this, null, function* () {
        ...
        yield addDpopTokenProofHeader(headers, request, endpoint, this.cryptoUtils, this.config.tokenBindingKeyManager);
    ...
    createTokenRequestBody(request) {
      return __async(this, null, function* () {
        ...
        (_c = this.performanceClient) == null ? void 0 : _c.addFields({
          hasAttributeTokens: !!((_b = request.attributeTokens) == null ? void 0 : _b.length)
        }, request.correlationId);
    ...
    acquireTokenWithCachedRefreshToken(request, foci, apiId) {
      return __async(this, null, function* () {
        ...
        if (refreshTokenRequest.authenticationScheme === AuthenticationScheme.DPOP && !refreshTokenRequest.dpopJkt) {
          ...
          refreshTokenRequest.dpopJkt = yield dpopProofGenerator.generateJkt(request.correlationId);
        }
        try {
    ...
    createTokenRequestBody(request) {
      return __async(this, null, function* () {
        ...
        (_d = this.performanceClient) == null ? void 0 : _d.addFields({
          hasAttributeTokens: !!((_c = request.attributeTokens) == null ? void 0 : _c.length)
        }, request.correlationId);
        if (this.config.clientCredentials.clientSecret) {
          addClientSecret(parameters, this.config.clientCredentials.clientSecret);
        }
  ...
  var SilentFlowClient = class {
    ...
    acquireCachedToken(request) {
      return __async(this, null, function* () {
        ...
        const cachedAccessTokenType = (_a = cachedAccessToken.tokenType) == null ? void 0 : _a.toLowerCase();
        if (cachedAccessTokenType === AuthenticationScheme.DPOP.toLowerCase()) {
          ...
          try {
            yield this.config.tokenBindingKeyManager.getTokenBindingPublicKeyJwk(cachedAccessToken.keyId, request.correlationId);
          } catch (e) {
    ...
    provisionTokenBindingKey(request) {
      return __async(this, null, function* () {
        ...
        try {
          ...
          publicKeyThumbMeasurement == null ? void 0 : publicKeyThumbMeasurement.end(__spreadValues({
            success: true
          }, this.getTokenBindingKeyTelemetry(activeKeyPair)));
          return activeKeyPair.keyId;
        } catch (e) {
          publicKeyThumbMeasurement == null ? void 0 : publicKeyThumbMeasurement.end({
            success: false,
  ...
  var CryptoOps = class {
    ...
    signTokenBindingJwt(header, payload, kid, correlationId) {
      return __async(this, null, function* () {
        var _a;
        let telemetry = {};
        const signTokenBindingJwtMeasurement = (_a = this.performanceClient) == null ? void 0 : _a.startMeasurement(CryptoOptsSignJwt, correlationId);
        try {
          ...
          signTokenBindingJwtMeasurement == null ? void 0 : signTokenBindingJwtMeasurement.end(__spreadValues({
            success: true
          }, telemetry));
  ...
  function validateDpopRequest(request, correlationId) {
    var _a, _b;
    if (!((_a = request.resourceRequestMethod) == null ? void 0 : _a.trim()) || !((_b = request.resourceRequestUri) == null ? void 0 : _b.trim())) {
      throw createClientConfigurationError(ClientConfigurationErrorCodes_exports.dpopMissingResourceContext, correlationId);
    }
  }
  function getTokenBindingRequestParams(request, tokenBindingKeyManager, logger, performanceClient) {
    return __async(this, null, function* () {
      switch (request.authenticationScheme) {
        case Constants_exports.AuthenticationScheme.DPOP:
          ...
          return {
            dpopJkt: yield tokenBindingKeyManager.provisionTokenBindingKey({
  ...
  var PlatformAuthInteractionClient = class extends BaseInteractionClient {
    ...
    acquireTokenRedirect(request, rootMeasurement, options) {
      return __async(this, null, function* () {
        ...
        const navigateToLoginRequestUrl = (_a = options == null ? void 0 : options.navigateToLoginRequestUrl) != null ? _a : true;
        try {
    ...
    handleRedirectPromise() {
      return __async(this, null, function* () {
        ...
        const _b = cachedRequest, { prompt, storeInCache } = _b, request = __objRest(_b, ["prompt", "storeInCache"]);
        if (prompt) {
    ...
    initializePlatformRequest(request) {
      return __async(this, null, function* () {
        ...
        const hasAttributeTokens = !!((_a = request.attributeTokens) == null ? void 0 : _a.length);
        (_b = this.performanceClient) == null ? void 0 : _b.addFields({
          hasAttributeTokens
        }, this.correlationId);
    ...
    handleExtraBrokerParams(request, embeddedClientId) {
      ...
      (_e = this.performanceClient) == null ? void 0 : _e.addFields({
  ...
  function buildConfiguration({ auth: userInputAuth, cache: userInputCache, system: userInputSystem, experimental: userInputExperimental, telemetry: userInputTelemetry }, isBrowserEnvironment) {
    ...
    const overlayedConfig = {
      auth: __spreadProps(__spreadValues(__spreadValues({}, DEFAULT_AUTH_OPTIONS), userInputAuth), {
        OIDCOptions: __spreadValues(__spreadValues({}, DEFAULT_AUTH_OPTIONS.OIDCOptions), userInputAuth == null ? void 0 : userInputAuth.OIDCOptions)
      }),
  ...
  var PlatformAuthDOMHandler = class _PlatformAuthDOMHandler {
    ...
    convertToPlatformBrokerResponse(response, correlationId) {
      ...
      const nativeResponse = {
        ...
        extendedLifetimeToken: (_a = response.extendedLifetimeToken) != null ? _a : false,
  ...
  var PopupClient = class extends StandardInteractionClient {
    ...
    executeCodeFlow(request, popupParams, pkceCodes) {
      return __async(this, null, function* () {
        ...
        const tokenBindingParams = yield getTokenBindingRequestParams(request, this.tokenBindingKeyManager, this.logger, this.performanceClient);
  ...
  var SilentIframeClient = class extends StandardInteractionClient {
    ...
    silentTokenHelper(authClient, request) {
      return __async(this, null, function* () {
        const { serverParams, pkceCodes, silentRequest } = yield this.silentAuthorizeHelper(authClient, request);
  ...
  var SilentRefreshClient = class extends StandardInteractionClient {
    ...
    acquireToken(request) {
      return __async(this, null, function* () {
        ...
        const tokenBindingParams = yield getTokenBindingRequestParams(baseRequest, this.tokenBindingKeyManager, this.logger, this.performanceClient);
  ...
  var SilentAuthCodeClient = class extends StandardInteractionClient {
    ...
    acquireToken(request) {
      return __async(this, null, function* () {
        ...
        const serverTelemetryManager = initializeServerTelemetryManager(this.apiId, this.config.auth.clientId, this.correlationId, this.browserStorage, this.logger, void 0, this.config.system.serverTelemetryEnabled);
        try {
          const tokenBindingParams = yield getTokenBindingRequestParams(silentRequest, this.tokenBindingKeyManager, this.logger, this.performanceClient);
  ...
  var StandardController = class _StandardController {
      ...
      return __async(this, null, function* () {
        ...
        return redirectResponse.then((result) => {
          ...
          if (result) {
            ...
            rootMeasurement.end({
              success: true,
              isNativeBroker: (_a2 = result.fromPlatformBroker) != null ? _a2 : false
    ...
    acquireTokenPopup(request) {
      ...
      if (this.canUsePlatformBroker(request)) {
        ...
        result = this.acquireTokenNative(__spreadProps(__spreadValues({}, request), {
          ...
          atPopupMeasurement.end({
            success: true,
            isNativeBroker: (_a = response.fromPlatformBroker) != null ? _a : false
      ...
      return result.then((result2) => {
        ...
        atPopupMeasurement.end({
          success: true,
          isNativeBroker: (_a = result2.fromPlatformBroker) != null ? _a : false,
    ...
    ssoSilent(request) {
      return __async(this, null, function* () {
        ...
        return result.then((response) => {
          ...
          (_b2 = this.ssoSilentMeasurement) == null ? void 0 : _b2.end({
            success: true,
            isNativeBroker: (_a2 = response.fromPlatformBroker) != null ? _a2 : false,
        ...
        try {
          if (request.code && request.nativeAccountId) {
            ...
            if (this.canUsePlatformBroker(request, request.nativeAccountId)) {
              ...
              atbcMeasurement.end({
                success: true,
                isNativeBroker: (_a = result.fromPlatformBroker) != null ? _a : false
              }, void 0, result.account);
              return result;
            } else {
  ...
  function toAuthError(err) {
    var _a;
    const correlationId = (_a = err.correlationId) != null ? _a : "";
    switch (err.code) {
    ...
    static initializeNestedAppAuthBridge() {
      return __async(this, null, function* () {
        ...
        try {
          ...
          const bridgeResponse = yield _BridgeProxy.sendRequestViaRegistry(_BridgeProxy.buildRequest("GetInitContext"));
  ...
  // outlook-addin/src/config.js
  var runtimeConfig = globalThis.CORNERSTONE_SIGNATURES_CONFIG || {};
  var CLIENT_ID2 = String(runtimeConfig.clientId || "");
  var TENANT_ID = String(runtimeConfig.tenantId || "");
  var SIGNATURE_API_SCOPE = `api://${CLIENT_ID2}/Signature.Read`;
  function assertConfigured() {
    if (!CLIENT_ID2 || !TENANT_ID) {
      throw new Error("Microsoft Entra application IDs have not been configured.");
    }
  }

  // outlook-addin/src/graph-profile.js
  var GRAPH_TOKEN_SCOPES = ["User.Read", "openid", "profile"];
  var msalInstance;
  function getMsalInstance() {
    return __async(this, null, function* () {
      assertConfigured();
      if (!msalInstance) {
        msalInstance = yield createNestablePublicClientApplication({
          auth: {
            clientId: CLIENT_ID2,
  ...
  function getAccessToken() {
    return __async(this, arguments, function* ({ interactive = false, scopes = GRAPH_TOKEN_SCOPES } = {}) {
      const instance = yield getMsalInstance();
      const tokenRequest = { scopes };
      try {
        const result = yield instance.acquireTokenSilent(tokenRequest);
        return result.accessToken;
      } catch (error) {
        if (interactive && isInteractionRequired(error)) {
          const result = yield instance.acquireTokenPopup(tokenRequest);
          return result.accessToken;
        }
        throw error;
      }
  ...
  function getSignatureApiAccessToken({ interactive = false } = {}) {
    return getAccessToken({ interactive, scopes: [SIGNATURE_API_SCOPE] });
  }
  function isInteractionRequired(error) {
    return error instanceof InteractionRequiredAuthError || (error == null ? void 0 : error.name) === "InteractionRequiredAuthError" || (error == null ? void 0 : error.errorCode) === "interaction_required" || (error == null ? void 0 : error.errorCode) === "login_required" || (error == null ? void 0 : error.errorCode) === "consent_required";
  }

  // outlook-addin/src/managed-signature.js
  var MANAGED_SIGNATURE_URL = "/api/outlook/signature";
  var ManagedSignatureError = class extends Error {
  ...
  function getManagedSignature() {
    return __async(this, arguments, function* ({ interactive = false, senderEmail = "" } = {}) {
      var _a, _b, _c, _d, _e, _f;
      const accessToken = yield getSignatureApiAccessToken({ interactive });
      ...
      const response = yield fetch(`${MANAGED_SIGNATURE_URL}${suffix}`, {
        method: "GET",
        cache: "no-store",
        headers: {
  ...
  // outlook-addin/src/runtime-entry.js
  Office.onReady();
  ...
  function setSignature(html, event) {
    Office.context.mailbox.item.body.setSignatureAsync(
      ...
      (result) => {
        var _a, _b;
        if (result.status === Office.AsyncResultStatus.Failed) {
          report("runtime_failed", `setSignatureAsync:${((_a = result.error) == null ? void 0 : _a.code) || ((_b = result.error) == null ? void 0 : _b.message) || "unknown"}`);
  ...
  function applySignatureForCurrentSender(_0) {
    return __async(this, arguments, function* (event, { clearWhenUnavailable = false } = {}) {
      ...
      try {
        ...
        report("runtime_failed", `${(error == null ? void 0 : error.name) || "Error"}:${(error == null ? void 0 : error.errorCode) || (error == null ? void 0 : error.code) || (error == null ? void 0 : error.message) || "unknown"}`);
        ...
        const message = error instanceof ManagedSignatureError && error.status === 403 ? "Your managed signature is currently unavailable. Contact IT if this continues." : "Cornerstone Signatures could not retrieve your managed signature. Try again or contact IT.";
        notify(
...
@azure/msal-browser/dist/webBrokerBridge/WebBrokerBridgeError.mjs:
@azure/msal-browser/dist/webBrokerBridge/WebBrokerBridgeErrorMap.mjs:
...
@azure/msal-browser/dist/webBrokerBridge/PendingRequestRegistry.mjs:
